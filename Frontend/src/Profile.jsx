      ...
      render() {
          return(
                    ...
                    <Row className="justify-content-md-center">
                        ...
                        <Col xs={12} md={5}>
                            ...
                            <Row>
                                ...
                                <Button onClick={this.profileToggle} color="primary">Edit Profile</Button>
                            </Row>
                ...
                <Modal isOpen={this.state.expenseModal} toggle={this.expenseToggle}>
                    <ModalHeader toggle={this.expenseToggle}>Detailed Expense</ModalHeader>
                    <ModalBody>
                        <CustomTable 
                            title="" 
                ...
                <Modal isOpen={this.state.profileModal} toggle={this.profileToggle}>
                    <ModalHeader toggle={this.profileToggle}>Detailed Expense</ModalHeader>
                    <ModalBody>
                        <h5>Edit Profile</h5>
                    </ModalBody> 
                    <ModalFooter>
                        <Button color="primary" onClick={this.profileToggle}>Done</Button>
                    </ModalFooter>       
                </Modal>
                </Container>
          );
